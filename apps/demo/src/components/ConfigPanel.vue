...
const groups: GroupDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'stagnationRate' },
      { key: 'diversityBoost' },
      { key: 'diversityBoostCap' },
      { key: 'diversityBoostFactor' },
      { key: 'catastropheThreshold' },
      { key: 'catastropheFraction' },
      { key: 'multiMutRate' },
      { key: 'nichingEnabled' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'banditEnabled' },
      { key: 'banditK', disabled: () => !cfg.value.banditEnabled },
      { key: 'banditExploration', disabled: () => !cfg.value.banditEnabled },
    ],
  },
  {
    key: 'penalties',
  ...
  },
  {
    ...
    fields: [
      { key: 'useInput' },
      { key: 'usePassBest' },
      { key: 'dagreLongestPath' },
      { key: 'dagreNetworkSimplex' },
      { key: 'dagreTightTree' },
      { key: 'dagreLR' },
      { key: 'elkLayered' },
      { key: 'elkMrTree' },
