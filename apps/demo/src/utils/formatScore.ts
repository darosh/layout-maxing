...
export function formatScore(n: number | undefined | null): string {
  ...
  if (n >= 1_000_000_000_000_000_000_000_000_000_000)
    return `${(n / 1_000_000_000_000_000_000_000_000_000_000).toFixed(1)}${SP}Q`
  if (n >= 1_000_000_000_000_000_000_000_000_000)
    return `${(n / 1_000_000_000_000_000_000_000_000_000).toFixed(1)}${SP}R`
  if (n >= 1_000_000_000_000_000_000_000_000)
    return `${(n / 1_000_000_000_000_000_000_000_000).toFixed(1)}${SP}Y`
  if (n >= 1_000_000_000_000_000_000_000)
    return `${(n / 1_000_000_000_000_000_000_000).toFixed(1)}${SP}Z`
