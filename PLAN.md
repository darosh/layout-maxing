...
- [x] **P1 — `toEntities` + `buildBoxEntityIndex` per mutation call**
      File: `packages/layout-maxing/src/genetic.ts`
...
- [x] **P2 — `fixOverlaps` (30×O(n²)) per offspring when `repairOffspring=true`**
      File: `packages/layout-maxing/src/layout.ts`
...
- [x] **P3 — `layoutShrinkEntities` fights the optimizer**
      File: `packages/layout-maxing/src/layout.ts`
